class SieuNhan:
    ...
    def __str__(self):
        return (f"   {self.ten:10} |  Vũ khí: {self.vu_khi:10} |  "
                f"Màu: {self.mau_sac:10} |  Sức mạnh: {self.suc_manh}")
    
danh_sach = []
print("=== NHẬP DANH SÁCH SIÊU NHÂN HIỆN TẠI=== ")
...
print(f"\n=== DANH SÁCH SIÊU NHÂN: {len(danh_sach)} ===")
